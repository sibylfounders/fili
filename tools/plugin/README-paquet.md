...
- `AGENTS.md` / `CLAUDE.md` — le **routeur** (contenu identique, deux noms selon l'agent).
  Il porte le protocole de build, le mode audit, la table « intentions → bundle » et la table des sujets.
...
4. Un sujet non couvert ou un arbitrage de design non tranché : l'agent **stoppe et remonte**
   au lieu d'improviser à partir des règles voisines.
...
Seule modification prévue côté consommateur : les **valeurs** de `tokens.yaml`, jamais ses
