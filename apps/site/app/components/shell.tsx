    ...
    <AppShell.Root>
      ...
      <AppShell.Tools>
        <div className="flex flex-col gap-md p-lg">
          ...
          <Row label="Rayon"><Select options={RADIUS_OPTS} value={radius} onValueChange={setRadius} aria-label="Rayon" size="sm" /></Row>
          <Row label="Relief"><Switch checked={relief} onCheckedChange={setRelief} aria-label="Relief" size="sm" /></Row>
          <Row label="Framework"><Select options={FW_OPTS} value={fw} onValueChange={setFw} aria-label="Framework" size="sm" /></Row>
          <Divider />
